  ...
  return (
    <main>
      ...
      <section className="hero">
        ...
        <div className="hero-actions"><a className="hero-cta" href="/build-my-kit?entry=homepage">Build my kit <span>→</span></a><a className="hero-secondary" href="#activities">Browse activities <span>↓</span></a></div>
      </section>
